  ...
  const onSubmit = async (data: VenueFormData) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Thank you! Your venue "${data.name}" has been submitted for review. Our team will review and approve your listing within 24-48 hours. You can log in to manage your venue once it's approved.`)
        
        // Redirect to success page
        router.push(`/add-venue/complete?venue=${encodeURIComponent(data.name)}`)
      } else {
          ...
          <Card>
            ...
            <CardContent className="space-y-4 pt-0">
              <p className="text-sm sm:text-body text-gray-600 mb-4">
                Set the price range for your venue (optional but recommended):
              </p>
              <div className="space-y-4 sm:grid sm:grid-cols-2 sm:gap-4 sm:space-y-0">
                <div>
                  <label className="block text-sm sm:text-callout font-medium text-black mb-2">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs sm:text-caption text-gray-500 mt-1">
                    Maximum price for premium bookings
                  </p>
                </div>
              </div>
            </CardContent>
