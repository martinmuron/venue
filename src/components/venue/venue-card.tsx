    ...
    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 group">
      <Link href={`/prostory/${venue.slug}`}>
        ...
        <CardContent className="p-6">
          <h3 className="text-title-3 text-black mb-2 group-hover:text-gray-700 transition-colors">
            {venue.name}
          </h3>
          
          <p className="text-callout text-gray-500 mb-3 line-clamp-2">
            {venue.address}
          </p>
          ...
          <div className="flex justify-between items-center text-callout">
